...
export const metadata: Metadata = {
  ...
  description: 'Meet Jade White, the Dorset-based artist and welder behind IronAwe. Learn about her passion for transforming reclaimed metal into awe-inspiring sculptures.',
  openGraph: {
